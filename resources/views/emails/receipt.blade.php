    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <![endif]-->
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <!-- start copy -->
                    <tr>
                        <td align="left" bgcolor="#ffffff" style="padding: 21px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff" style="padding: 21px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td align="left" bgcolor="#e0e0e0" width="50%" style="padding: 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;"><strong>Order #</strong></td>
                                    <td align="left" bgcolor="#e0e0e0" width="50%" style="padding: 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; text-align: right;"><strong>{{$payment->order_id}}</strong></td>
                                </tr>
                                <tr>
        ...
        <!-- start footer -->
        <tr>
            <td align="center" bgcolor="#e0e0e0" style="padding: 24px;">
                <!--[if (gte mso 9)|(IE)]>
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="600">
        <tr>
        <td align="center" valign="top" width="600">
        <![endif]-->
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <!-- start permission -->
                    <tr>
                        <td align="center" bgcolor="#e0e0e0" style="padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;">
                            <p style="margin: 0;">You received this email because we received a request for ordering an event . If you didn't request this order, you can safely delete this email.</p>
                        </td>
                    </tr>
                    <!-- end permission -->
                </table>
